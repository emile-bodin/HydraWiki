...
type GenerationRun = { id: string; page_path: string; status: "running" | "succeeded" | "failed"; error: string | null; started_at: string; completed_at: string | null; diagrams: MermaidDiagram[] };
